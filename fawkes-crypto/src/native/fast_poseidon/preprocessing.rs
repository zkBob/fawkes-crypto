...
use crate::native::fast_poseidon::utils::quintic_s_box;

use super::{mds::MdsMatrices, matrix::{apply_matrix, vec_add}};
...
pub(crate) fn compress_round_constants<Fr: PrimeField>(
    width: usize,
    full_rounds: usize,
    partial_rounds: usize,
    round_constants: &Vec<Num<Fr>>,
    mds_matrices: &MdsMatrices<Fr>,
    ...
    let mut partial_keys: Vec<Num<Fr>> = Vec::new();
    ...
    if partial_preprocessed == 1 {
        ...
        // X
        let initial_state = vec![Num::ONE; width];
